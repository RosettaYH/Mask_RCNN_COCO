...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        food_list = ['caesar_salad', 'caprese_salad', 'edamame', 'french_fries', 'fried_calamari', 'fried_rice', 'omelette']
        food_num = 1
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "data_final1_group4.json")))
