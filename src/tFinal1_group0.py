...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        self.add_class("food", 1, "group1")
        self.add_class("food", 2, "group2")
        self.add_class("food", 3, "group3")
        self.add_class("food", 4, "group4")
        self.add_class("food", 5, "group5")
        self.add_class("food", 6, "group6")
        self.add_class("food", 7, "group7")

        # Train or validation dataset?
        assert subset in ["train", "val"]
        dataset_dir = os.path.join(dataset_dir, subset)

        annotations = json.load(open(os.path.join(dataset_dir, "data_final1_group0.json")))
        ...
        for a in annotations:
            ...
            self.add_image( "food", image_id=a['filename'],path=image_path, width=width, height=height, polygons=polygons, class_ids=class_ids)
...
if __name__ == '__main__':
    ...
    #weights_path = "/home/rosetta/COCO_Food101/model_trained_classV4.hdf5"
