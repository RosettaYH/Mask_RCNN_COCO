...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        food_list = ['bibimbap', 'clam_chowder', 'hot_and_sour_soup', 'lobster_bisque', 'miso_soup', 'pho', 'pancakes']
        food_num = 1
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "data_final1_group3.json")))
