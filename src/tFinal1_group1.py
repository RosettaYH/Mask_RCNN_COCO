...
class FoodConfig(Config):
    ...
    NUM_CLASSES = 1 + 8  # Background + 3 classes
...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        food_list = ['apple_pie', 'beignets', 'cannoli', 'cheesecake', 'chocolate_cake', 'creme_brulee', 'red_velvet_cake', 'tiramisu']
        food_num = 1
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "data_final1_group1.json")))
