...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        food_list = ['chicken_quesadilla', 'crab_cakes', 'deviled_eggs', 'donuts', 'escargots', 'macarons', 'scallops']
        food_num = 1
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "data_final1_group5.json")))
