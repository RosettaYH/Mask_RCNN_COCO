...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        food_list =['breakfast_burrito', 'club_sandwich', 'croque_madame', 'grilled_cheese_sandwich', 'lasagna', 'lobster_roll_sandwich', 'waffles']
        food_num = 1
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "data_final1_group6.json")))
